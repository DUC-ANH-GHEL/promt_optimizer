...
__export(index_exports, {
  ...
  ALL_STORAGE_KEYS_ARRAY: () => ALL_STORAGE_KEYS_ARRAY,
  APIError: () => APIError,
  BaseError: () => BaseError,
  CORE_SERVICE_KEYS: () => CORE_SERVICE_KEYS,
  ChangeType: () => ChangeType,
  CompareCalculationError: () => CompareCalculationError,
  CompareError: () => CompareError,
  CompareService: () => CompareService,
  CompareValidationError: () => CompareValidationError,
  DataManager: () => DataManager,
  DexieStorageProvider: () => DexieStorageProvider,
  ERROR_MESSAGES: () => ERROR_MESSAGES,
  ElectronConfigManager: () => ElectronConfigManager,
  ElectronDataManagerProxy: () => ElectronDataManagerProxy,
  ElectronHistoryManagerProxy: () => ElectronHistoryManagerProxy,
  ElectronLLMProxy: () => ElectronLLMProxy,
  ElectronModelManagerProxy: () => ElectronModelManagerProxy,
  ElectronPreferenceServiceProxy: () => ElectronPreferenceServiceProxy,
  ElectronPromptServiceProxy: () => ElectronPromptServiceProxy,
  ElectronTemplateLanguageServiceProxy: () => ElectronTemplateLanguageServiceProxy,
  ElectronTemplateManagerProxy: () => ElectronTemplateManagerProxy,
  FileStorageProvider: () => FileStorageProvider,
  HistoryChainError: () => HistoryChainError,
  HistoryError: () => HistoryError,
  HistoryManager: () => HistoryManager,
  HistoryNotFoundError: () => HistoryNotFoundError,
  InitializationError: () => InitializationError,
  IterationError: () => IterationError,
  LLMError: () => LLMError,
  LLMService: () => LLMService,
  LocalStorageProvider: () => LocalStorageProvider,
  MODEL_SELECTION_KEYS: () => MODEL_SELECTION_KEYS,
  ...
  RequestConfigError: () => RequestConfigError,
  ServiceDependencyError: () => ServiceDependencyError,
  StaticLoader: () => StaticLoader,
  StorageError: () => StorageError,
  StorageFactory: () => StorageFactory,
  TEMPLATE_SELECTION_KEYS: () => TEMPLATE_SELECTION_KEYS,
  TemplateCacheError: () => TemplateCacheError,
  ...
  TestError: () => TestError,
  UI_SETTINGS_KEYS: () => UI_SETTINGS_KEYS,
  ValidationError: () => ValidationError,
  advancedParameterDefinitions: () => advancedParameterDefinitions,
  checkVercelApiAvailability: () => checkVercelApiAvailability,
  createCompareService: () => createCompareService,
  ...
  createPreferenceService: () => createPreferenceService,
  createPromptService: () => createPromptService,
  createTemplateLanguageService: () => createTemplateLanguageService,
  createTemplateManager: () => createTemplateManager,
  debugIPCSerializability: () => debugIPCSerializability,
  defaultModels: () => defaultModels,
  getProxyUrl: () => getProxyUrl,
  isBrowser: () => isBrowser,
  isElectronApiReady: () => isElectronApiReady,
  isElectronRenderer: () => isElectronRenderer,
  isRunningInElectron: () => isRunningInElectron,
  messageTemplateSchema: () => messageTemplateSchema,
  resetVercelStatusCache: () => resetVercelStatusCache,
  safeSerializeArgs: () => safeSerializeArgs,
  safeSerializeForIPC: () => safeSerializeForIPC,
...
var messageTemplateSchema = import_zod.z.object({
...
var templateSchema = import_zod.z.object({
  ...
  content: import_zod.z.union([
    ...
    import_zod.z.array(messageTemplateSchema).min(1)
  ]),
  metadata: import_zod.z.object({
    ...
    templateType: import_zod.z.enum(["optimize", "userOptimize", "iterate"]),
    language: import_zod.z.enum(["zh", "en"]).optional()
  }).passthrough(),
  // 允许额外字段通过验证
  isBuiltin: import_zod.z.boolean().optional()
});
...
var compile = import_handlebars.default.compile.bind(import_handlebars.default);
var registerHelper = import_handlebars.default.registerHelper.bind(import_handlebars.default);
  ...
  static buildMessages(template9, context) {
    ...
    if (Array.isArray(template9.content)) {
      if (CSPSafeTemplateProcessor.isExtensionEnvironment()) {
        ...
        return template9.content.map((msg) => ({
          role: msg.role,
          content: import_handlebars.default.compile(msg.content, { noEscape: true })(context)
        }));
      }
    }
...
var HistoryManager = class {
  ...
  async createNewChain(params) {
    const chainId = (0, import_uuid.v4)();
    const record = {
      ...params,
      chainId,
      version: 1,
...
var LLMService = class {
  ...
  getOpenAIInstance(modelConfig, isStream = false) {
    ...
    const instance = new import_openai.default(config);
    return instance;
  }
  /**
   * 获取Gemini实例
...
var PromptOptimizerDB = class extends import_dexie.default {
  constructor() {
...
var CompareService = class {
  ...
  performTextComparison(original, optimized, options) {
    ...
    switch (options.granularity) {
      case "char":
        diffResult = (0, import_diff.diffChars)(processedOriginal, processedOptimized);
        break;
      case "word":
      default:
        diffResult = (0, import_diff.diffWords)(processedOriginal, processedOptimized);
        break;
    }
